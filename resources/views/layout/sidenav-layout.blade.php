...
<body>
            ...
            <div class="d-flex float-right h-auto">
                <div class="user-dropdown">
                    ...
                    <div class="user-dropdown-content">
                        ...
                        <a class="side-bar-item" href="{{ route('profile') }}">
    ...
    <div class="side-nav-open" id="sideNavRef">
        ...
        <a class="side-bar-item {{Request::is('dashboard')?'active':''}}" href="{{ route('dashboard') }}">
            <i class="bi bi-graph-up"></i>
            <span class="side-bar-item-caption">Dashboard</span>
        </a>

        <a class="side-bar-item {{Request::is('customer')?'active':''}}" href="{{ route('customer') }}">
            <i class="bi bi-people"></i>
            <span class="side-bar-item-caption">Customer</span>
        </a>

        <a class="side-bar-item {{Request::is('category')?'active':''}}" href="{{ route('category') }}">
            <i class="bi bi-list-nested"></i>
            <span class="side-bar-item-caption">Category</span>
        </a>

        <a class="side-bar-item {{Request::is('product')?'active':''}}" href="{{ route('product') }}">
            <i class="bi bi-bag"></i>
            <span class="side-bar-item-caption">Product</span>
        </a>

        <a class="side-bar-item {{Request::is('sale')?'active':''}}" href="{{ route('sale') }}">
            <i class="bi bi-currency-dollar"></i>
            <span class="side-bar-item-caption">Create Sale</span>
        </a>

        <a class="side-bar-item {{Request::is('invoice')?'active':''}}" href="{{ route('invoice') }}">
            <i class="bi bi-receipt"></i>
            <span class="side-bar-item-caption">Invoice</span>
        </a>

        <a class="side-bar-item {{Request::is('report')?'active':''}}" href="{{ route('report') }}">
