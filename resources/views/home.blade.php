    ...
    <nav class="navbar sticky-top navbar-expand-lg navbar-light py-2 shadow-sm">
        <div class="container">
            ...
            <div class="navbar-collapse collapse" id="header01">
                ...
                <div><a class="btn bg-gradient-primary mt-3" href="{{ route('login') }}">Start Sale</a></div>
            </div>
        </div>
    </nav>
        ...
        <div class="container pt-2">
            <div class="row align-items-center mb-5">
                <div class="col-12 col-md-10 col-lg-5 mb-lg-0 mb-5">
                    ...
                    <div class="d-flex flex-wrap"><a class="btn bg-gradient-primary mb-sm-0 mb-2 me-2" href="{{ route('login') }}">Start Sale</a>
                        <a class="btn bg-gradient-primary mb-sm-0 mb-2" href="{{ route('login') }}">Login</a>
                    </div>
                </div>
